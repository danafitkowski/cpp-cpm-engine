...
console.log('\n=== v2.1 Wave B4 — manifest field ===');
{
    ...
    check('manifest.engine_version === 2.9.12',
        r.manifest.engine_version === '2.9.13');
    ...
    check('E.ENGINE_VERSION exported', E.ENGINE_VERSION === '2.9.13');
}
...
console.log('\n=== Section I — computeScheduleHealth (D3) ===');
{
    ...
    check('D3: engine_version present', h.engine_version === '2.9.13');
...
}
{
    ...
    check('E3: engine_version in disclosure', d.engine_version === '2.9.13');
}
{
    ...
    check('E3: null result → engine_version present',
        dCaught && dCaught.engine_version === '2.9.13');
}
