...
`generated_at:` (will be filled in by `buildDaubertDisclosure()` at runtime; this static document was first written 2026-05-24. CORRECTION (2026-09-22): the paragraph below was itself last refreshed against a 2026-09-21 working tree and had gone stale across the v2.9.42 through v2.9.45 tagged releases without being updated in step — it is preserved verbatim as a historical record of that specific refresh, not as a description of the current release. For the current figures see the top of this document, §2, §4, and CHANGELOG.md's v2.9.46 entry. As of v2.9.46: 1,307 unit tests, 53 fixtures / 1167 of 1183 cross-validation comparisons executed, 16 skipped, 0 failures.
