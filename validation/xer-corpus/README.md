...
This corpus is BEHIND the current engine, and regenerating surfaces real drift that is not yet committed or recorded in `CHANGELOG.md`: case 10's project finish moves from 2026-01-18 to 2026-01-25, and the alert count rises in every case except `06-fully-completed` — 12 of the 13 case folders now on disk.
