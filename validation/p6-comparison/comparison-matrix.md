...
| 04 | `04-sf-edge-case` | 2026-01-12 | 0 | ❌ FAIL (see comparison.csv) | Least-common rel type; SF behavior varies with P6 progress-override setting |
| 05 | `05-negative-float` | 2026-01-21 | 1 | ❌ FAIL (see comparison.csv) | FNLT constraint produces negative TF |
| 06 | `06-multiple-calendars` | 2026-01-19 | 0 | ❌ FAIL (see comparison.csv) | Activity-specific calendars (5-day vs 6-day) |
| 07 | `07-ontario-holidays` | 2026-05-13 | 0 | ✅ PASS | Long activity across CA-ON statutory holidays |
| 08 | `08-in-progress-retained-logic` | 2026-01-28 | 0 | ✅ PASS | Predecessor in-progress; successor anchored to projected EF |
| 09 | `09-completed-successor` | 2026-01-12 | 2 | ❌ FAIL (see comparison.csv) | Backward-pass skip; no pull-back through historical finish |
| 10 | `10-out-of-sequence-progress` | 2026-01-26 | 1 | ❌ FAIL (see comparison.csv) | Out-of-sequence ALERT path |
| 11 | `11-mandatory-start-finish` | 2026-01-30 | 2 | ❌ FAIL (see comparison.csv) | MS_Start + MS_Finish hard pins |
| 12 | `12-snet-fnlt` | 2026-02-03 | 1 | ✅ PASS | SNET + FNLT (most common P6 constraints) |
| 13 | `13-alap` | 2026-01-22 | 0 | ✅ PASS | ALAP secondary constraint |
