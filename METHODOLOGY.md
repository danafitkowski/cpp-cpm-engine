...
**Rule.** The JavaScript engine and the Python reference implementation must produce bit-identical output on every cross-validation fixture. As of v2.9.10: **281 / 281 checks bit-identical** across 25 fixtures, plus a 282-activity real-XER stress test with 0 mismatches. Backed by 728 unit tests.
