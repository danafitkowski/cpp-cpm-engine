...
The local witness JSON (`witness-v2.9.34.json` in this folder) was generated by `scripts/attestation.js` against the committed source at the SHAs above. The Sigstore-signed CI witness will be attached to the GitHub release page after the tag is pushed.
