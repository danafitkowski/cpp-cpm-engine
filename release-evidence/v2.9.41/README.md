...
console.log('Engine version:', result.manifest.engine_version); // 2.9.41
```
...
> Fitkowski, D. (2026). *cpm-engine: An open-source critical-path-method engine with AACE-canonical method labels and a published Daubert disclosure.* Critical Path Partners. Version 2.9.41. <https://github.com/danafitkowski/cpp-cpm-engine>
