...
[![npm version](https://img.shields.io/badge/npm-v2.9.12-blue.svg)](https://www.npmjs.com/package/@critical-path-partners/cpm-engine)
...
See [CHANGELOG.md](CHANGELOG.md) for the full release history through v2.9.12.
