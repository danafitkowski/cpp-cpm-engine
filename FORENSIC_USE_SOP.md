...
- Verify the deliverable's report manifest references:
  - Engine version (e.g., `cpm-engine v2.9.41`)
...
This SOP is aligned to `cpm-engine` v2.9.41. SOP revisions are tracked in [`CHANGELOG.md`](CHANGELOG.md) under the engine version that introduced them.
